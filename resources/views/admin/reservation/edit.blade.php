    ...
    <div id="page-wrapper">
        <div id="page-inner">
                        ...
                        <div class="panel-body">
                            <form name="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="title" id="title" class="form-control" required>
                                        {{-- <option value selected></option> --}}
                                         <option value="Dr.">{{$reservation->title}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="fname" id="fname" value = "{{$reservation->fname}}" class="form-control" required>
                                    @if ($errors->has('fname'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="lname" id="lname"  value = "{{$reservation->lname}}" class="form-control" required>
                                    @if ($errors->has('lname'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="email" id="email" value = "{{$reservation->email}}"   type="email" class="form-control" required readonly>
                                    @if ($errors->has('email'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country" id="country" class="form-control" required>
                                        <option value selected>{{$reservation->country_name}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="state" id="state" class="form-control" required>
                                     <option value selected>{{$reservation->state_name}}</option>
                                    </select>
                                    @if ($errors->has('state'))
                                ...
                                <div class="form-group">
                                    ...
                                    <option value selected>{{$reservation->city_name}}</option>
                                    </select>
                                    @if ($errors->has('city'))
                                ...
                                <div class=" form-group">
                                    ...
                                    <input name="phone" id="phone" value = "{{$reservation->phone}}"   type="text" class="form-control" required>
                                    @if ($errors->has('phone'))
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <select name="troom" id="troom" class="form-control" required>
                                           <option value selected> {{$reservation->name}}  </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value selected> {{$reservation->room_name}}  </option>
                                        </select>
                                        @if ($errors->has('nroom'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bed" id="bed" class="form-control" required>
                                            <option value selected>{{$reservation->bed}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="meal" id="meal" class="form-control" required>
                                            <option value selected> {{$reservation->meal}}  </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="cin" id="cin"  value = "{{$reservation->cin}}"   class="form-control" placeholder="Check In Date"
                                            required>
                                        @if ($errors->has('cin'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="cout" id="cout"  value = "{{$reservation->cout}}"   class="form-control" placeholder="check out Date"
                                            required>
                                        @if ($errors->has('cout'))
            ...
            <div class="text-center">
                <button type="submit" id="one" class="btn btn-primary btn-lg">Submit</button>
            </div>
        </div>
        <!-- /. PAGE INNER  -->
    </div>
        ...
        $('#one').on('click', function(e) {
            ...
            if (title != "" && fname != "" && lname != "" && email != "" &&
                ...
                $.ajax({
                    ...
                    url: "/Edit&&detail%%Post/{{$reservation->id}}",
                    type: "POST",
                    data: {
                        title: title,
                        fname: fname,
