...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
                    <figure class="img-absolute">
                        <img src="home/images/food-1.jpg" alt="Image" class="img-fluid">
                    </figure>
    ...
    <!-- Menu -->
    <section class="section bg-image overlay" style="background-image: url('home/images/hero_3.jpg');">
        <div class="container">
                    ...
                    @foreach ($food_category as $fc)
                        <li class="nav-item">
                            <a class="nav-link @if ($fc->id == 1) active @endif letter-spacing-2" id="{{ $fc->name }}-tab" data-toggle="tab"
                                href="#{{ $fc->name }}" role="tab" aria-controls={{ $fc->name }}
                                aria-selected="true">{{ $fc->name }}</a>
                        </li>
                    @endforeach
                </ul>
                    ...
                    @foreach ($review as $rv)
                        <div class="testimonial text-center slider-item">
                            <div class="author-image mb-3">
                                <img src={{ asset('home/' . $rv->image) }} alt="Image placeholder"
