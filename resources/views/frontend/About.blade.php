...
@section('content')
    ...
    @endforeach
    <section class="site-hero inner-page overlay" style="background-image: url({{ asset('home/images/hero_4.jpg') }})"
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
                    <figure class="img-absolute">
                        <img src="home/images/food-1.jpg" alt="Free Website Template by Templateux" class="img-fluid">
                    </figure>
                    <img src="home/images/img_1.jpg" alt="Image" class="img-fluid rounded">
                </div>
                <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
                    <h2 class="heading">Welcome!</h2>
                    <p class="mb-4">{{ $about->body }}</p>
                    <p><span class="mr-3 font-family-serif"></span> <a href={{ $about->video }} data-fancybox
    ...
    <div class="container section">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="block-2">
                    <div class="flipper">
                        <div class="front" style="background-image: url({{ asset('home/images/person_3.jpg') }});">
                            <div class="box">
                                <h2>Huỳnh Tấn Duy</h2>
                                <p>President</p>
                            </div>
                        ...
                        <div class="back">
                            <!-- back content -->
                            <blockquote>
                                <p>&ldquo;Today you are You, that is truer than true. There is no one alive who is Youer
                                    than You.&rdquo;</p>
                            </blockquote>
                            <div class="author d-flex">
                                ...
                                <div class="name align-self-center">Will Peters <span class="position">President</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="block-2">
                    <!-- .hover -->
                    <div class="flipper">
                        <div class="front" style="background-image: url({{ asset('home/images/person_1.jpg') }});">
                            <div class="box">
                        ...
                        <div class="back">
                            <!-- back content -->
                            <blockquote>
                                <p>&ldquo;I’m selfish, impatient and a little insecure. I make mistakes, I am out of control
                                    and at times hard to handle. But if you can’t handle me at my worst, then you sure as
                                    hell don’t deserve me at my best.&rdquo;</p>
                            </blockquote>
                            <div class="author d-flex">
                                <div class="image mr-3 align-self-center">
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="block-2">
                    <div class="flipper">
                        <div class="front" style="background-image: url({{ asset('home/images/person_2.jpg') }});">
                            <div class="box">
                        ...
                        <div class="back">
                            ...
                            <div class="author d-flex">
                                <div class="image mr-3 align-self-center">
                                    <img src="{{ asset('home/images/person_2.jpg') }}" alt="">
                                </div>
